    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        <li class="menu-header">&nbsp;</li>
          <li class="menu-header">&nbsp;</li>
          <li><a class="nav-link" href="/satpam"><i class="fas fa-columns"></i> <span class="ml-3">Blank Page</span></a></li>
          <li><a class="nav-link" href="/satpam/profile"><i class="fas fa-user"></i> <span class="ml-3">Profile</span></a></li>
