...
<body>
  ...
  <ul class="navbar-nav navbar-right">
    <li>
      ...
      <img alt="image" style="border-style: solid;" src="{{ assset('assets/img/avatar/avatar-1.png')}}" class="ml-2 border border-dark rounded-circle mr-1"></a>
    </li>
    <li>
...
<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      ...
      <img src="{{ assset('images/logo.jpeg')}}" class="block text pl-5 pr-5" style="height: 5em" />
    </div>
  ...
  <script src="{{ assset('assets/js/stisla.js')}}"></script>

  <!-- JS Libraies -->
  <script src="../node_modules/fullcalendar/dist/fullcalendar.min.js"></script>

  <!-- Template JS File -->
  <script src="{{ assset('assets/js/scripts.j')}}s"></script>
  <script src="{{ assset('assets/js/custom.js')}}"></script>

  <!-- Page Specific JS File -->
	<script src="{{ assset('assets/js/page/modu')}}les-calendar.js"></script>
