...
@section('title','Data Presensi User')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div style="border-radius: 30px; position: absolute; object-position: center; left: 35%;">
                                <a href="{{ url('hrd/data-presensi/'.$presensiID.'/excel') }}" style="padding-top: 2%; padding-bottom: 2%;" class="btn btn-light" type="button">Export Excel <i
                                ...
                                <table class="table table-bordered table-md">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $s->phone }}</td>
                                            <td>
                                                @if ($s->pivot->status == 'ON TIME')
                                                <span class="badge badge-success">On Time</span>
                                                @elseif($s->pivot->status == 'LATE')
                                                <span class="badge badge-warning">Late</span>
                                                @elseif($s->pivot->status == 'SKIP')
...
@include('pages.hrd.modal.presensi-user-attachment')
@endsection
