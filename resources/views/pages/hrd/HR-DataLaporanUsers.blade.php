                    ...
                    <div class="card">
                        <div class="card-header">
                            <div style="border-radius: 30px; position: absolute; object-position: center; left: 35%;">
                                <a href="{{ url('hrd/data-lokasi/'.$barcodeID.'/excel-barcode') }}" style="padding-top: 2%; padding-bottom: 2%;" class="btn btn-light" type="button">Export Excel <i
...
@include('pages.hrd.modal.laporan-user-attachment')
@endsection
