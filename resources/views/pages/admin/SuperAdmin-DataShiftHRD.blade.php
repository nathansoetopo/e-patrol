...
@section('main-content')
                  ...
                  <div class="card-header">
                    ...
                    <div style="border-radius: 30px; position: absolute; object-position: center; left: 84%;">
                      <button style="padding-top: 2%; padding-bottom: 2%;" data-toggle="modal" data-target="#addData"
                        class="btn btn-light" type="button">Assign HRD <i class="fas fa-plus"></i></button>
                    </div>
                  </div>
  ...
  @include('pages.admin.modal.assign-hrd-shift')
  @include('pages.admin.modal.resign-hrd-shift')
  @endsection