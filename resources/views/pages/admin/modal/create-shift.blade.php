...
<div class="modal fade" tabindex="-1" role="dialog" id="addData">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/admin/data-shift') }}">
                @csrf
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="time" step="1" class="form-control timepicker" name="start_time">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="time" step="1" class="form-control timepicker" name="end_time">
                            </div>
                        </div>
                    </div>
                </div>
