    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update Data HRD</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="{{ url('/admin/data-hrd/'.$s->id.'/update-data') }}">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Nama Lengkap</label>
                        <input type="text" placeholder="Masukkan Nama Lengkap HRD" style="border-radius: 30px;"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" style="border-radius: 30px;" placeholder="Masukkan NIK HRD"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" style="border-radius: 30px;" placeholder="Masukkan Email HRD"
                            class="form-control" id="email" name="email" value="{{ $s->email }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Password</label>
                        <input type="password" style="border-radius: 30px;" placeholder="Masukkan Password HRD"
